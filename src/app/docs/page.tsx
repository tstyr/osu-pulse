import { Bot, Database, Disc3, ExternalLink, Film, KeyRound, ServerCog } from "lucide-react";
...
const steps = [
  ...
  { icon: Film, title: "Local Renderer", body: "Botとは独立したRendererを起動すると、Webからもdanserへレンダーを依頼できます。", code: "renderer/start_renderer.bat" },
];

export default function DocsPage() {
  return (
    <main className="mx-auto w-full max-w-5xl px-5 py-16 sm:py-24">
      <div className="max-w-2xl"><p className="font-mono text-[10px] uppercase tracking-[0.2em] text-pink-300">deployment guide</p><h1 className="mt-4 text-4xl font-medium tracking-[-0.055em] text-white">最初のリザルト通知まで、6ステップ。</h1><p className="mt-4 text-sm leading-7 text-zinc-500">WebはVercel、データはNeon、Gateway・音楽・Rendererは独立したローカルワーカーへ分離しています。</p></div>
